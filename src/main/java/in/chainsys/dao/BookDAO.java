	...
	public  List<Book> displayAllBook()  throws ClassNotFoundException, SQLException{
		...
		try {
			...
			while (rs.next()) {
				...
				Book book = new Book(bookId,bookName,bookSerialId, author,bookPublications,yearOfPublicaions,numberOfCopies,bookAvailablitystatus,bookBayNumber,bookShelfNumber);
