...
public class AddBookService {
	...
	public static boolean addBooks(String bookName, String author, String bookPublication, String yearOfPublication,
			int numberOfCopies, String bookAvailablityStatus, String bookBayNumber, String bookShelfNumber)
			throws SQLException, ClassNotFoundException, ExistingBookException {
		...
		if (bookValid) {
			Book book = new Book(bookId, name, serailNumber, bookAuthor, publication, yearOfPubliction, copies,
					availablityStatus, bayNumber, shelfNumber);
