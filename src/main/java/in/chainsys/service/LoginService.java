...
public class LoginService {
	...
	public static boolean adminLoginValidation(Long number, String password)
			throws ClassNotFoundException, SQLException, InvalidCredentialsExcepions {
		...
		if (isValidId && isValidFormat && adminCredentialTable.containsKey(number)
				&& password.equals(adminCredentialTable.get(number))) {
			isValidAdmin = true;
		} else {
